...
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js" integrity="sha384-Tc5IQib027qvyjSMfHjOMaLkfuWVxZxUPnCJA7l2mCWNIpG9mGCD8wGNIcPD7Txa" crossorigin="anonymous"></script>
        ...
        <body>
            ...
            <?php echo form_open('Ctrl_Composant/modComposant');  ?>
            
            
            <h4><b>Veuillez saisir les informations du composant à modifier</b></h4>
            <br><label>Code: </label><input type="text" name="CMP_CODE" value="<?php echo $unCode[0]->CMP_CODE; ?>" />
            <br><label>Libelle: </label><input type="text" name="CMP_LIBELLE" value="<?php echo $unCode[0]->CMP_LIBELLE; ?>" />

            <input type="hidden" name ="hidden_id" value="<?php echo $unCode[0]->CMP_CODE; ?>">          
